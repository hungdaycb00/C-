...
namespace Session12
{
    class Program
    {
        ...
        static void Snippet2()
        {
            int valOne = 5;
            int valTwo = 23;
            Calculation objCalculation = new Calculation(Mathematics.Addition);
        ...
        {
            Maths objMaths = new Maths(MathsDemo.Addition);
            objMaths += new Maths(MathsDemo.Subtraction);
            objMaths += new Maths(MathsDemo.Multiplication);
            objMaths += new Maths(MathsDemo.Division);
            if (objMaths != null)
            {
                objMaths(20, 10);
            }
